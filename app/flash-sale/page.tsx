...
export const metadata: Metadata = {
  title: "Flash Sale - Limited Time Deals & Discounts | 1stopDokan",
  description: "Shop 1stopDokan's exclusive Flash Sale! Save big on high-quality premium clothing, panjabi, embroidery designs, and lifestyle items with special deals in Bangladesh.",
  alternates: {
